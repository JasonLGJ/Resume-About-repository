package com.swust.admins.Widget;
 ...
 */
public class adminsWidget extends AppWidgetProvider {

    final static private String btnCallMessage  = "com.swust.admins.Widget.btn.call";

    final static public  String updateAllWidget = "com.swust.admins.Widget.update.all";
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager, int appWidgetId) {
        ...
        RemoteViews views = new RemoteViews(context.getPackageName(), R.layout.admins_widget);
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        // Construct the RemoteViews object
        RemoteViews remoteViews = new RemoteViews(context.getPackageName(), R.layout.admins_widget);
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (btnCallMessage.equals(action)) {
                ...
                switch (resId) {
                    case R.id.IFAFUWidgetContent:
                        ...
                        startIntent.setComponent(
                                new ComponentName(
                                        "com.swust.admins",
                                        "com.swust.admins.SyllabusActivity"));
            ...
            ComponentName thisName = new ComponentName(context, adminsWidget.class);
