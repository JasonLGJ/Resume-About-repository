...
import com.swust.admins.About.AboutActivity;
import com.swust.admins.Main.controller.AdController;
import com.swust.admins.Base.BaseActivity;
import com.swust.admins.Base.controller.TitleBarController;
import com.swust.admins.Exam.ExamActivity;
import com.swust.admins.Main.controller.LeftMenuController;
import com.swust.admins.Main.controller.UpdateController;
import com.swust.admins.Main.dialog.UpdateDialog;
import com.swust.admins.Main.model.UpdateInf;
import com.swust.admins.MainApplication;
import com.swust.admins.Base.ProtectActivity;
import com.swust.admins.R;
import com.swust.admins.Responsibility.CopyingActivity;
import com.swust.admins.Responsibility.ResponsibilityActivity;
import com.swust.admins.Score.ElectiveScoreActivity;
import com.swust.admins.Score.ScoreActivity;
import com.swust.admins.Score.controller.ScoreAsyncController;
import com.swust.admins.Syllabus.SyllabusActivity;
import com.swust.admins.Syllabus.controller.SyllabusAsyncController;
import com.swust.admins.User.LoginActivity;
import com.swust.admins.User.controller.UserAsyncController;
import com.swust.admins.Base.WebActivity;
import com.swust.admins.Main.delegate.LeftMenuClickedDelegate;
import com.swust.admins.User.delegate.ReplaceUserDelegate;
import com.swust.admins.Base.delegate.TitleBarButtonOnClickedDelegate;
import com.swust.admins.Score.delegate.UpdateMainScoreViewDelegate;
import com.swust.admins.Syllabus.delegate.UpdateMainSyllabusViewDelegate;
import com.swust.admins.Syllabus.delegate.UpdateMainUserViewDelegate;
import com.swust.admins.User.dialog.AccountSettingDialog;
import com.swust.admins.Base.dialog.ProgressDialog;
import com.swust.admins.Syllabus.model.Course;
import com.swust.admins.Score.model.Score;
import com.swust.admins.Score.model.ScoreTable;
import com.swust.admins.Syllabus.model.Syllabus;
...
public class MainActivity extends BaseActivity
    ...
    private void InitLeftController() {
        ...
        Map<String, List<String>>   leftMenuTabs        = new HashMap<String, List<String>>() {{
            ...
            put("关于软件", Arrays.asList("关于iSWUST", "贡献名单", "开源协议", "隐私条款与免责声明"));
        }};
    ...
    public void onTabClick(int tabIndex) {
        switch (tabIndex) {
            ...
            case 1:
                ...
                break;
            case 2:
                Toast.makeText(this, getString(R.string.error_grade_exam_query), Toast.LENGTH_SHORT).show();
                break;
            case 3:
                gotoExamActivity();
                break;
