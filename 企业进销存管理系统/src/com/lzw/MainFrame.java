...
public class MainFrame extends JFrame {// 主窗体
	...
	private JPanel getStatePanel() {
		if (statePanel == null) {// 状态面板对象为空
			GridBagConstraints gridBagConstraints6 = new GridBagConstraints();// 创建网格限制对象6
			...
			GridBagConstraints gridBagConstraints4 = new GridBagConstraints();// 创建网格限制对象4
			gridBagConstraints4.gridx = 3;// 组件位于网格的横向索引为3
			gridBagConstraints4.gridy = 0;// 组件位于网格的纵向索引为0
			GridBagConstraints gridBagConstraints3 = new GridBagConstraints();// 创建网格限制对象3
			...
			GridBagConstraints gridBagConstraints11 = new GridBagConstraints();// 创建网格限制对象11
			...
			GridBagConstraints gridBagConstraints2 = new GridBagConstraints();// 创建网格限制对象2
			...
			nameLabel = new JLabel("西南科技大学解忧杂货铺   ");// “公司名称”标签
			GridBagConstraints gridBagConstraints1 = new GridBagConstraints();// 创建网格限制对象1
			...
			GridBagConstraints gridBagConstraints = new GridBagConstraints();// 创建网格限制对象0
	...
	private void initialize() {// 初始化主窗体的方法
		...
		this.setTitle("解忧杂货铺-进销存管理系统");// 设置窗体的题目
	}
