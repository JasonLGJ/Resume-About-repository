package com.Jason.FaceAttendance.Utils;
...
public final class FinalUtil {
	//face++的api_key
	public final static String API_KEY = "iL4Ci-2GMbUJhu7p6ADFnOwoMM4tp7lR";
	public final static String API_Secret = "NY22Q9Y8r2Y0PACoaVICqcDfJgsB_Vd8";
